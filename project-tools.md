...
[dotnet-lambda](https://github.com/aws/aws-extensions-for-dotnet-cli) | Tools to deploy AWS Lambda functions. [NuGet](https://www.nuget.org/packages/Amazon.Lambda.Tools)
