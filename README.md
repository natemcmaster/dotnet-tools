...
[dotnet-fm](https://fluentmigrator.github.io/articles/runners/dotnet-fm.html) | [@FluentMigrator](https://github.com/fluentmigrator) | FluentMigrator: Is a database migration framework for .NET much like Ruby on Rails Migrations. [NuGet](https://www.nuget.org/packages/FluentMigrator.DotNet.Cli/)
