...
`fake-cli` | [FAKE](https://www.nuget.org/packages/dotnet-fake/) | [@fsharp](https://github.com/fsharp) | F# MAKE 5 - A DSL FOR BUILD TASKS AND MORE. [GitHub](https://github.com/fsharp/Fake)
