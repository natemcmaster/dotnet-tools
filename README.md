...
[dotnet-config2json](https://github.com/andrewlock/dotnet-config2json) | A simple tool to convert a web.config file to an appsettings.json file. [NuGet](https://www.nuget.org/packages/dotnet-config2json/)
