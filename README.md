...
`dotnet-retire`| [dotnet-retire](https://github.com/RetireNet/dotnet-retire) | [@johnkors](https://github.com/johnkors) |  A dotnet CLI extension to check your project for known vulnerabilities. [GitHub](https://github.com/retirenet/dotnet-retire)
