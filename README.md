...
`dotnet-cake` |  [dotnet-cake](https://www.nuget.org/packages/Cake.Tool/) | [@cake-build](https://github.com/cake-build/) | A tool to run cross platform Cake build scripts. [GitHub](https://github.com/cake-build/cake)
