...
[dotnet-script](https://github.com/filipw/dotnet-script) | [@filipw](https://github.com/filipw) | Run C# scripts from the .NET CLI. [NuGet](https://www.nuget.org/packages/dotnet-script/)
