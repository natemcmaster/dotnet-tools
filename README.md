...
`dotnet-encrypto` | [Nuget](https://www.nuget.org/packages/dotnet-encrypto) | [@tomchavakis](https://github.com/tomchavakis) | A tool to encrypt/decrypt folder or files using AES 256 Encryption Algorithm [Github](https://github.com/tomchavakis/encrypto)
